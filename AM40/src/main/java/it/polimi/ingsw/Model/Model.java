...
public class Model {
    ...
    /**
     * A boolean which if it is true, the game has started
     */
    private boolean hasStarted;
    /**
     * A boolean which if it is true, the game has ended
     */
    ...
    /**
     * Sets the order of the tiles picked by player p according the the array t
     * @param p 'player
